...
This PFE report addresses the design, implementation, and evaluation of a conversational assistant for enterprise document access. The following boundaries apply:
...
The remainder of this PFE report is organized as follows:

\textbf{Chapter~\ref{chap:background}} establishes the theoretical and empirical foundations of the work through a comprehensive review of the literature on LLMs, RAG architectures, vector search, enterprise knowledge management, the Model Context Protocol, and enterprise AI security. It concludes by identifying the research gap this PFE report fills.
...
\textbf{Chapter~\ref{chap:conclusion}} synthesizes the contributions of the report, provides explicit answers to each research question, and outlines the directions for future work, including a proposed research agenda for CIFRE doctoral continuation.
