...
Two independent annotators label the ground-truth relevant chunks for each question. Overall inter-annotator agreement is measured using Cohen's $\kappa$ [TBC]; pairs on which the annotators disagree are adjudicated and revised before inclusion in the benchmark.
