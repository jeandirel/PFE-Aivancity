...
Participants rate the following 10 statements on a 5-point Likert scale (1 = Strongly Disagree, 5 = Strongly Agree):
...
The five task scenarios to be used in the task-based evaluation:
