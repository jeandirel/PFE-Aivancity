...
This appendix documents the structure and annotation guidelines for the 50-item benchmark dataset used in the evaluation of Chapter~\ref{chap:evaluation}. The full dataset is provided in machine-readable format (JSON Lines) alongside this mémoire.
