...
This appendix documents the structure and annotation guidelines for the 50-item benchmark dataset used in the evaluation of Chapter~\ref{chap:evaluation}. The full dataset is provided in machine-readable format (JSON Lines) alongside this PFE report.
...
Overall inter-annotator agreement (Cohen's $\kappa$) is computed at dataset level over the paired annotator labels and reported in Chapter~\ref{chap:evaluation} [TBC].

\section*{Annotation Guidelines}

Annotators are provided the following guidelines:
