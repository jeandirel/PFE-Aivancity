...
\item \textbf{H4:} The MCP protocol overhead does not exceed 200~ms at P95 (NFR04 MCP budget).
\item \textbf{H5:} User acceptance of AntiGravity meets the threshold of SUS \$\geq 68\$ and TAM Perceived Usefulness significantly higher than self-reported SharePoint satisfaction.
\item \textbf{H6:} Cross-encoder re-ranking improves MRR over bi-encoder-only retrieval by at least 15\% relative.
\end{itemize}
