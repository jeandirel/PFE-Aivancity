%==============================================================================
% PFE REPORT (MÉMOIRE DE PROJET DE FIN D'ÉTUDES) — AIVANCITY PGE5
...
\usepackage[
  ...
  pdfsubject={Mémoire de Projet de Fin d'Études (PFE) — Aivancity PGE5},
...
\fancyhf{}
\fancyhead[L]{\small\nouppercase{\leftmark}}
\fancyhead[R]{\small Aivancity PGE5}
\fancyfoot[C]{\thepage}
