...
\begin{figure}[H]
\centering
\IfFileExists{figures/chapter_01/parcours_as_is.png}{%
  \includegraphics[width=0.98\textwidth]{figures/chapter_01/parcours_as_is.png}%
}{%
  \fbox{\parbox{0.95\textwidth}{\centering Image manquante : figures/chapter\_01/parcours\_as\_is.png}}%
}
\caption{Parcours actuel de recherche d'information (as-is) et principaux points de friction}
\label{fig:as_is_recherche_ch1}
\end{figure}
...
\begin{figure}[H]
\centering
\IfFileExists{figures/chapter_01/parcours_to_be.png}{%
  \includegraphics[width=0.98\textwidth]{figures/chapter_01/parcours_to_be.png}%
}{%
  \fbox{\parbox{0.95\textwidth}{\centering Image manquante : figures/chapter\_01/parcours\_to\_be.png}}%
}
\caption{Parcours cible avec l'Assistant RAG DNSI (to-be) : recherche assistée, sources et boucle de retour}
\label{fig:to_be_rag_ch1}
\end{figure}
